...
//            self.labelExercise.text = "\(exercise!)\(ago)"
            ...
            if  let _ : PFObject = request.objectForKey("scheduleInfo") as? PFObject {
                
                self.labelExercise.textColor = UIColor(red: 255/255.0, green: 141/255.0, blue: 2/255.0, alpha: 1)
                
                let schTime = request.objectForKey("scheduledTime") as? NSDate
                
                if schTime != nil {
                    
                    self.labelExercise.text = "Scheduled: " + (AppDelegate.formatScheduleTime(schTime) as String)
                }
            ...
            else
            {
                ...
                self.labelExercise.textColor = UIColor(red: 1/255.0, green: 211/255.0, blue: 140/255.0, alpha: 1)
                self.labelExercise.text = "Train Now!"
            }
    ...
    func setupMotivateMeWithRequest(request: PFObject) {
